...
import { IonIcon, IonLabel, IonModal, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent } from '@ionic/react';
      ...
      <IonModal isOpen={modalIsOpen} onDidDismiss={() => setModalIsOpen(false)}>
        <IonHeader>
          <IonToolbar>
            ...
            <IonButtons slot="end">
              <IonButton onClick={() => setModalIsOpen(false)}>{capitalize(t("close"))}</IonButton>
            </IonButtons>
          </IonToolbar>
        </IonHeader>
        <IonContent className="ion-padding">
          <IonButton onClick={removeTextColor} expand="full" shape="round" color={accent}>
            <IonIcon icon={refresh} /> {capitalize(t("follow"))+t("between_words")+t("system")+t("between_words")+t("accent_color")}
          </IonButton>
          <IonButton onClick={() => changeTextColor(hex)} expand="full" shape="round" color={accent}>
