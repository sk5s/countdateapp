...
public class CountdateWidget extends AppWidgetProvider {
    String eventName = "No Data";
    String eventDate = "No Data";
    @Override
            ...
            if (strJson != null) {
                try {
                    ...
                    for (int x = 0; x < response.length(); x++){
                        ...
                        if (eventObj.getString("id") == eventId){
                            eventName = eventObj.getString("event_name");
                            eventDate = eventObj.getString("date");
